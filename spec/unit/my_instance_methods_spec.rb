  ...
  describe 'MyInstanceMethods' do
    before :all do
      ModelOne = Class.new do
        ...
        embeds_many :emb_fours, store_as: :emfs, class_name: 'EmbFour'
      end
      ...
      describe 'embeds_one' do
        before(:all) do
          Mail = Class.new do
            ...
            field :provider
            embeds_one :mail_subject, class_name: 'MailSubject'
          end
      ...
      describe 'paranoia' do
        before(:all) do
          ModelParanoia = Class.new do
            ...
            embeds_many :emb_para_ones, class_name: 'EmbParaOne'
          end
      ...
      describe 'embeds_one' do
        before(:all) do
          Email = Class.new do
            ...
            field :provider
            embeds_one :email_subject, class_name: 'EmailSubject'
          end
        ...
        context 'when embeds_one has alias' do
          before(:all) do
            ...
            ModelTwo = Class.new do
              ...
              embeds_one :emb_two_one, class_name: 'EmbTwoOne'
            end
        ...
        context 'when embeds_many has alias' do
          before(:all) do
            ...
            ModelTwo = Class.new do
              ...
              include Mongoid::History::Trackable
              store_in collection: :model_twos
              embeds_many :emb_two_ones, class_name: 'EmbTwoOne'
            end
